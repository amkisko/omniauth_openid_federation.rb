# omniauth_openid_federation RFCs
...
Standards Track, Stable: RFC 0003 (strategy and callback), RFC 0004 (trust chain and entity statements), RFC 0005 (token verification), RFC 0006 (federation endpoint and keys).
