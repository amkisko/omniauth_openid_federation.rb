...
execute_command("bundle exec appraisal rails8 rspec 2>&1 | tee tmp/rspec.log")
...
gem_name = "omniauth_openid_federation"
version_file = "lib/omniauth_openid_federation/version.rb"
